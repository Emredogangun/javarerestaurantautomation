 ...
 * @author EMRE
 */
public class Masa2 implements ActionListener{
        Connection con;
    ...
    public Masa2(){
        getMasa2Frame().add(getMasa2Panel());
        getMasa2Frame().setVisible(true);
        
         getMasa2Panel().add(getArayemekler());
        getMasa2Panel().add(getArayemekl());
        getMasa2Panel().add(getArayemeklr());        
        getMasa2Panel().add(getArayemekName());
        
        
        getMasa2Panel().add(getAnayemekler());
        getMasa2Panel().add(getAnayemekl());
        getMasa2Panel().add(getAnayemeklr());
        getMasa2Panel().add(getAnayemekName());
        
        getMasa2Panel().add(getSalata());       
        getMasa2Panel().add(getSalatal());
        getMasa2Panel().add(getSalatalr());        
        getMasa2Panel().add(getSalataName());

        getMasa2Panel().add(getIcecek());       
        getMasa2Panel().add(getIcecekl());
        getMasa2Panel().add(getIceceklr());
        getMasa2Panel().add(getIcecekName());

        getMasa2Panel().add(getsiparisGoruntule());
        getMasa2Panel().add(getgeriDon());
        getMasa2Panel().add(getanasayfaDon());
        getMasa2Panel().add(getekle());
        getMasa2Panel().add(getHesapal());
        getMasa2Panel().add(getTplmucret());  
...
public JFrame getMasa2Frame() {
        if (Masa2Frame == null) {
            Masa2Frame = new JFrame("MASA 2");
            Masa2Frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            Masa2Frame.setBounds(300, 10, 735, 720);
            
        }
        return Masa2Frame;
    }

    public void setMasa2Frame(JFrame Masa2Frame) {
        this.Masa2Frame = Masa2Frame;
    }
    
    public JPanel getMasa2Panel() {
        if (Masa2Panel == null) {
            Masa2Panel = new JPanel();
            Masa2Panel.setLayout(null);
            Masa2Panel.setBackground(Color.white);
            Masa2Panel.setBounds(0, 0, 0, 0);
    ...
    public JButton getsiparisGoruntule() {
        ...
        st=con.createStatement();
            ...
            rs=st.executeQuery("SELECT * FROM siparisler WHERE masano='2'");
            ...
            Masa2Panel.add(scrollpaneli);


                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(Masa2.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void setSiparisGoruntule(JButton siparisGoruntule) {
        ...
        st=con.createStatement();
            ...
            String sorgu=String.format("DELETE FROM siparisler WHERE masano='2'");
            Statement stmt=con.createStatement(); 
            stmt.executeUpdate(sorgu);
            try{
            Statement stmtt=con.createStatement(); 
            String sorguu=String.format("insert into istatistik values(NULL, '2', %d)", fatura);
