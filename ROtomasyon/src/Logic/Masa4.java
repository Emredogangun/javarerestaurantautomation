 ...
 * @author EMRE
 */
public class Masa4 implements ActionListener{
        Connection con;
    ...
    public Masa4(){
        getMasa4Frame().add(getMasa4Panel());
        getMasa4Frame().setVisible(true);
        
         getMasa4Panel().add(getArayemekler());
        getMasa4Panel().add(getArayemekl());
        getMasa4Panel().add(getArayemeklr());        
        getMasa4Panel().add(getArayemekName());
        
        
        getMasa4Panel().add(getAnayemekler());
        getMasa4Panel().add(getAnayemekl());
        getMasa4Panel().add(getAnayemeklr());
        getMasa4Panel().add(getAnayemekName());
        
        getMasa4Panel().add(getSalata());       
        getMasa4Panel().add(getSalatal());
        getMasa4Panel().add(getSalatalr());        
        getMasa4Panel().add(getSalataName());

        getMasa4Panel().add(getIcecek());       
        getMasa4Panel().add(getIcecekl());
        getMasa4Panel().add(getIceceklr());
        getMasa4Panel().add(getIcecekName());

        getMasa4Panel().add(getsiparisGoruntule());
        getMasa4Panel().add(getgeriDon());
        getMasa4Panel().add(getanasayfaDon());
        getMasa4Panel().add(getekle());
        getMasa4Panel().add(getHesapal());
        getMasa4Panel().add(getTplmucret());  
...
public JFrame getMasa4Frame() {
        if (Masa4Frame == null) {
            Masa4Frame = new JFrame("MASA 2");
            Masa4Frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            Masa4Frame.setBounds(300, 10, 735, 720);
            
        }
        return Masa4Frame;
    }

    public void setMasa4Frame(JFrame Masa4Frame) {
        this.Masa4Frame = Masa4Frame;
    }
    
    public JPanel getMasa4Panel() {
        if (Masa4Panel == null) {
            Masa4Panel = new JPanel();
            Masa4Panel.setLayout(null);
            Masa4Panel.setBackground(Color.white);
            Masa4Panel.setBounds(0, 0, 0, 0);
    ...
    public JButton getsiparisGoruntule() {
        ...
        st=con.createStatement();
            ...
            rs=st.executeQuery("SELECT * FROM siparisler WHERE masano='4'");
            ...
            Masa4Panel.add(scrollpaneli);


                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(Masa4.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void setSiparisGoruntule(JButton siparisGoruntule) {
        ...
        st=con.createStatement();
            ...
            String sorgu=String.format("DELETE FROM siparisler WHERE masano='4'");
            Statement stmt=con.createStatement(); 
            stmt.executeUpdate(sorgu);
            try{
            Statement stmtt=con.createStatement(); 
            String sorguu=String.format("insert into istatistik values(NULL, '4', %d)", fatura);
